              ...
              >
                ...
                <div className="w-full aspect-square overflow-hidden flex items-center justify-center pt-2">
                  <img
                    src={item.thumbnail}
                    alt={item.title}
                    className="object-contain w-[85%] h-[85%] group-hover:scale-105 transition-transform"
                  />
                </div>
                ...
                <div className="mt-4 flex flex-col flex-grow text-left">
                  ...
                  <div className="flex items-center gap-1.5 mt-2">
                    <div className="flex">
                      {[...Array(5)].map((_, index) => {
                        const fillPercent =
                          Math.min(Math.max((item.rating || 0) - index, 0), 1) *
                          100;
                        return (
                          <div key={index} className="relative w-3.5 h-3.5">
                            <svg
                              ...
                              viewBox="0 0 24 24"
                              fill="currentColor"
                              className="absolute top-0 left-0 w-3.5 h-3.5 text-gray-200"
                            >
                              <path
                                fillRule="evenodd"
