  ...
  if (!checkoutItems || checkoutItems.length === 0) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center bg-[#f4f6f8]">
        ...
        <Link to="/cart" className="text-[#e30019] font-bold hover:underline">
          Quay lại giỏ hàng
        </Link>
      </div>
    );
          ...
          <div className="col-span-1 lg:col-span-8 space-y-6">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
              <h2 className="text-lg font-bold text-gray-900 mb-6 flex items-center gap-2">
                <span className="bg-[#e30019] text-white w-6 h-6 rounded-full flex items-center justify-center text-sm">
                  1
                </span>
                Thông tin nhận hàng
              </h2>
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              <label className="flex items-center gap-4 p-4 border-2 border-[#e30019] bg-red-50 rounded-xl cursor-pointer">
                <input
                  ...
                  checked
                  readOnly
                  className="w-5 h-5 accent-[#e30019]"
                />
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-500">
                    Khách hàng kiểm tra hàng và thanh toán cho shipper.
                  </span>
                </div>
              </label>
            </div>
                ...
                {checkoutItems.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col flex-grow">
                      <span className="text-sm font-semibold text-gray-900 line-clamp-2 leading-snug">
                        {item.title}
                      </span>
                      <span className="text-xs text-gray-500 mt-1">
                        Phân loại: {item.colorSelected}
                      </span>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 w-full max-w-md flex flex-col items-center text-center animate-[popIn_0.4s_ease-out_forwards]">
            ...
            <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mb-6">
              <svg
                ...
                strokeWidth={3}
                stroke="currentColor"
                className="w-12 h-12 text-green-500 animate-[checkMark_0.6s_ease-in-out_forwards]"
              >
                <path
                  strokeLinecap="round"
            ...
            <p className="text-gray-500 mb-6 leading-relaxed">
              Cảm ơn <b>{formData.name}</b> đã mua sắm tại TechVolt.
              <br />
